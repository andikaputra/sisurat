...
if(isset($_GET['id_request_skb'])){
	...
	$tampil_nik = "SELECT * FROM data_request_skb NATURAL JOIN data_pemohon WHERE id_request_skb=$id";
						...
						<form method="POST" enctype="multipart/form-data">
							<div class="card">
								<div class="card-header">
									<div class="card-title">UBAH DATA REQUEST SURAT KETERANGAN KELAKUAN BAIK</div>
								</div>
								<div class="card-body">
									<div class="row">
											<div class="col-md-6 col-lg-6">
												...
												<input type="text" name="nik1" class="form-control" value="<?= $nik;?>" hidden>
											</div>
                                            <div class="col-md-6 col-lg-6">
                                                <div class="form-group">
...
if(isset($_POST['ubah'])){
	$keperluan = $_POST['keperluan'];
		...
		$file_ktp = $_POST['nik1']."_".".jpg";
		$nama_kk = isset($_FILES['kk']);
    	$file_kk = $_POST['nik1']."_".".jpg";
    	
	$sql = "UPDATE data_request_skb SET scan_ktp='$file_ktp',scan_kk='$file_kk',keperluan='$keperluan' WHERE id_request_skb=$id";
	...
	if($query){
		...
		echo '<meta http-equiv="refresh" content="3; url=?halaman=request_skb">';
	  }
}
