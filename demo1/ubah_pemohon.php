									...
									<div class="row">
											<div class="col-md-6 col-lg-6">
												...
												<div class="form-group">
													...
													<input type="text" name="kebangsaan" class="form-control" placeholder="Kebangsaan Anda.." value="<?= $kebangsaan;?>">
												</div>
											</div>
											<div class="col-md-6 col-lg-6">
												<div class="form-group">
												...
												<div class="form-group">
													<label>Telepon</label>
													<input type="text" name="telepon" class="form-control" value="<?= $telepon?>" placeholder="Telepon Anda..">
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<input type="text" name="lingkungan" class="form-control" value="<?= $lingkungan?>" placeholder="lingkungan Anda..">
												</div>
											</div>
									</div>
								</div>
