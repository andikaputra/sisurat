							...
							<div class="card full-height">
								<div class="card-body">
								    <div class="card-tools">
                                        <form action="" method="POST">
                                            ...
                                            <label>Keterangan</label>
                                                ...
                                                <!-- <input type="date" name="tgl_acc" class="form-control"> -->
                                                    ...
                                                    <a href="cetak_skb.php?id_request_skb=<?=$id;?>" base target='_blank' class="btn btn-primary btn-sm">Cetak</a>
                                        ...
                                        if(isset($_POST['ttd'])){
                                            $cetak = $_POST['dicetak'];
                                            $update = mysqli_query($konek,"UPDATE data_request_skb SET keterangan='$cetak', status=3 WHERE id_request_skb=$id");
                                            if($update){
                                                echo "<script language='javascript'>swal('Selamat...', 'Kirim Berhasil', 'success');</script>" ;
                                                echo '<meta http-equiv="refresh" content="3; url=?halaman=surat_dicetak">';
                                            }else{
                                                echo "<script language='javascript'>swal('Gagal...', 'Kirim Gagal', 'error');</script>" ;
                                                echo '<meta http-equiv="refresh" content="3; url=?halaman=view_skb">';
                                            }
                                ...
                                <!--         <tr>
                                    ...
                                    <table border="0" align="center">
                                        <tr>
                                            <td>
                                                <center>
                                                    <font size="4"><b>SURAT KETERANGAN KELAKUAN BAIK</b></font><br>
                                    ...
                                    <table class=MsoTableGrid border=0 cellspacing=0 cellpadding=1 align="center">
 <tr >
  <td >
 ...
 <tr>
  ...
  <table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
   ...
   mso-yfti-tbllook:1184;mso-padding-alt:0in 5.4pt 0in 5.4pt'>
    ...
    <tr>
    <td colspan="3">No. registrasi : masih coba</td>
   </tr>
   <tr>
