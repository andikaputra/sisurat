...
<?php
	if(isset($_GET['id_request_skbpk'])){
		$id_request_skbpk=$_GET['id_request_skbpk'];
		$sql = "SELECT * FROM data_request_skbpk natural join data_pemohon WHERE id_request_skbpk='$id_request_skbpk'";
										...
										<div class="col-md-6 col-lg-6">
												...
												<div class="col-md-6 col-lg-6">
													...
													<div class="form-group">
														...
														<input type="text" name="keperluan" value="<?php echo $keperluan;?>" class="form-control" placeholder="Keperluan Anda.." readonly="">
													</div>
												</div>
										</div>
									</div>
...
<?php
	if(isset($_POST['ubah'])){
		...
		if($query==1){
			$keterangan = $_POST['keterangan'];
			$ubah = "UPDATE data_request_skbpk SET
		keterangan='$keterangan' WHERE id_request_skbpk='$id_request_skbpk'";
		...
		if($quey==1){
			...
			echo '<meta http-equiv="refresh" content="3; url=?halaman=detail_skbpk">';
		  }
	}
?>