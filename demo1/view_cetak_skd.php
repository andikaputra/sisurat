								    ...
								    <div class="card-tools">
                                        <form action="" method="POST">
                                            ...
                                            <label>Keterangan</label>
                                                ...
                                                <!-- <input type="date" name="tgl_acc" class="form-control"> -->
                                                    ...
                                                    <a href="cetak_skd.php?id_request_skd=<?=$id;?>" base target='_blank' class="btn btn-primary btn-sm">Cetak</a>
                                                <!-- <div class="form-group">
                                        ...
                                        if(isset($_POST['ttd'])){
                                            ...
                                            if($update){
                                                ...
                                                echo '<meta http-equiv="refresh" content="5; url=?halaman=surat_dicetak">';
                                            }else{
                                                echo "<script language='javascript'>swal('Gagal...', 'Kirim Gagal', 'error');</script>" ;
                                                echo '<meta http-equiv="refresh" content="5; url=?halaman=view_skd">';
                                            }
