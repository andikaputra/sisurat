							...
							<div class="card full-height">
								<div class="card-body">
								    <div class="card-tools">
                                        <form action="" method="POST">
                                            ...
                                            <label>Keterangan</label>
                                                ...
                                                <!-- <input type="date" name="tgl_acc" class="form-control"> -->
                                                    ...
                                                    <a href="cetak_skdoa.php?id_request_skdoa=<?=$id;?>" base target='_blank' class="btn btn-primary btn-sm">Cetak</a>
                                                <!-- <div class="form-group">
                                        ...
                                        if(isset($_POST['ttd'])){
                                            $cetak = $_POST['dicetak'];
                                            $update = mysqli_query($konek,"UPDATE data_request_skdoa SET keterangan='$cetak', status=3 WHERE id_request_skdoa=$id");
                                            if($update){
