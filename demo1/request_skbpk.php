						...
						<form method="POST" enctype="multipart/form-data">
							<div class="card">
								<div class="card-header">
									<div class="card-title">FORM TAMBAH REQUEST SURAT KETERANGAN BELUM PERNAH KAWIN</div>
								</div>
								<div class="card-body">
									<div class="row">
											...
											<div class="form-group">
												...
												<div class="form-group">
													...
													<input type="text" name="keperluan" class="form-control"  placeholder="Masukkan Keperluan Anda.." required>
												</div>
											</div>
...
if(isset($_POST['kirim'])){
	...
	$keperluan = $_POST['keperluan'];
    	...
    	$nama_lingkungan = $_POST['lingkungan'];
	$sql = "INSERT INTO data_request_skbpk (nik,keperluan,scan_ktp,scan_kk, lingkungan) VALUES ('$nik','$keperluan','$file_ktp','$file_kk','$nama_lingkungan')";
	...
	if($query){
		...
		echo '<meta http-equiv="refresh" content="3; url=?halaman=request_skbpk">';
	  }
}
