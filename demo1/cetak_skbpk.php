...
<head>
    ...
    <title>Surat Keterangan Belum Pernah Kawin <?php echo $nama;?></title>
                                ...
                                <!--         <tr>
                                    ...
                                    <table border="0" align="center">
                                        <tr>
                                            <td>
                                                <center>
                                                    <font size="3"><b>SURAT KETERANGAN BELUM PERNAH KAWIN</b></font><br>
...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=5 align="center" width="600px">
 <tr >
  <td >
  <table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0 width="180px">
   <tr>
      <td colspan="3">
  ...
  <table class=MsoTableGrid border=0 cellspacing=0 cellpadding=2 style="border-left: 1px black solid" width="450px">
      <tr>
