										...
										<div class="table-responsive">
											<table id="add1" class="display table table-striped table-hover" >
												...
												<tbody>
													<?php
														$i=1;
														$sql = "SELECT * FROM data_request_skl natural join data_pemohon where status=2";
													...
													<tr>
														...
														<td>
															<div class="form-button-action">
																<a type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="View Surat" href="?halaman=view_skl&id_request_skl=<?= $id_request_skl;?>">
