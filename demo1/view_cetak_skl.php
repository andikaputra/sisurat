                                        ...
                                        <form action="" method="POST">
                                            ...
                                            <label>Keterangan</label>
                                                ...
                                                <!-- <input type="date" name="tgl_acc" class="form-control"> -->
                                                    ...
                                                    <a href="cetak_skl.php?id_request_skl=<?=$id;?>" base target='_blank' class="btn btn-primary btn-sm">Cetak</a>
                                                <!-- <div class="form-group">
                                                    <a href="cetak_skdoa.php?id_request_skdoa=<?php $id;?>">
                                                        Cetak
                                                    </a>
                                                </div> -->
                                                <!-- <div class="form-group">
                                                   <a href="cetak_skdoa.php?id_request_skdoa=<?=$id;?>">a</a>
                                                </div> -->
                                            </div>
                                        </form>
                                        <?php
...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=1 align="center" width="600px">
 <tr >
  <td >
  <table class=MsoTableGrid border=0 cellspacing=0 cellpadding=2 align="center" width="200px">
   <tr>
      <td colspan="3">
...
<table border=1 width="500px" align= "center" style='border-collapse:collapse;'>
  ...
  <tr>
      ...
      <td>:</td>
      <td width="200px"><?php echo $nama_ayah;?></td>
      <td width="200px">TTD</td>
  </tr>
    <tr>
      <td width="150px" >NIK</td>
      <td>:</td>
      <td width="200px"><?php echo $nik_ayah;?></td>
  </tr>
  <tr>
      <td width="150">Tempat/ Tgl Lahir</td>
      <td>:</td>
      <td width="200"><?php echo $tmpl_ayah;?>, <?php echo $format7;?></td>
   </tr>
    <tr>
