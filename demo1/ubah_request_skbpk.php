...
if(isset($_GET['id_request_skbpk'])){
	...
	$tampil_nik = "SELECT * FROM data_request_skbpk NATURAL JOIN data_pemohon WHERE id_request_skbpk=$id";
						...
						<form method="POST" enctype="multipart/form-data">
							<div class="card">
								<div class="card-header">
									<div class="card-title">UBAH REQUEST SURAT KETERANGAN BELUM PERNAH KAWIN</div>
								</div>
								<div class="card-body">
									<div class="row">
...
if(isset($_POST['ubah'])){
    ...
    $sql = "UPDATE data_request_skbpk SET
    keperluan='$keperluan',
    scan_ktp='$file_ktp',
    scan_kk='$file_kk' WHERE id_request_skbpk=$id";
	...
	if($query){
		...
		echo '<meta http-equiv="refresh" content="3; url=?halaman=ubah_skbpk">';
	  }
}
