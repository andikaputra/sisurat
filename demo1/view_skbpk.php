								...
								<div class="card-body">
								    <div class="card-tools">
                                        ...
                                        if(isset($_POST['ttd'])){
                                            ...
                                            $tgl = $_POST['tgl_acc'];
                                            $update = mysqli_query($konek,"UPDATE data_request_skbpk SET acc='$tgl', status=4, keterangan='$ket' WHERE id_request_skbpk=$id");
                                            if($update){
                                                echo "<script language='javascript'>swal('Selamat...', 'ACC Lurah Berhasil', 'success');</script>" ;
                                                echo '<meta http-equiv="refresh" content="3; url=?halaman=belum_acc_skbpk">';
                                            }else{
                                                echo "<script language='javascript'>swal('Gagal...', 'ACC Lurah Gagal', 'error');</script>" ;
                                                echo '<meta http-equiv="refresh" content="3; url=?halaman=view_skbpk">';
                                            }
