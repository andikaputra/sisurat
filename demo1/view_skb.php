								...
								<div class="card-body">
								    <div class="card-tools">
                                        ...
                                        if(isset($_POST['ttd'])){
                                            ...
                                            $tgl = $_POST['tgl_acc'];
                                            $update = mysqli_query($konek,"UPDATE data_request_skb SET acc='$tgl', status=4, keterangan='$ket' WHERE id_request_skb=$id");
                                            if($update){
                                                echo "<script language='javascript'>swal('Selamat...', 'ACC Lurah Berhasil', 'success');</script>" ;
                                                echo '<meta http-equiv="refresh" content="3; url=?halaman=belum_acc_skb">';
                                            }else{
