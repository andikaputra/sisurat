							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="fw-bold text-uppercase">BELUM ACC SURAT KETERANGAN KELAKUAN BAIK</h4>
									</div>
								</div>
								<div class="card-body">
									<form action="" method="POST">
										<div class="table-responsive">
											<table id="add1" class="display table table-striped table-hover" >
												...
												<tbody>
													<?php
														$sql = "SELECT * FROM data_request_skb natural join data_pemohon where status=2";
													...
													<tr>
														...
														<td>
															<div class="form-button-action">
																<a type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="View Surat" href="?halaman=view_skb&id_request_skb=<?= $id;?>">
																<i class="fa fa-edit"></i></a>
															</div>
														</td>
													</tr>
