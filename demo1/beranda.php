					...
					<div class="row mt--2">
						<div class="col-md-3 pr-md-0">
								<div class="card-pricing2 card-primary">
									<div class="pricing-header">
										<h6 class="fw-bold text-center text-uppercase">Surat Keterangan Kelakuan Baik</h6>
									</div>
									...
									<a href="?halaman=request_skb" class="btn btn-primary btn-round btn-sm mb-3"><span class="btn-label">
						...
						<div class="col-md-3 pr-md-0">
								<div class="card-pricing2 card-success">
									<div class="pricing-header">
										<h6 class="fw-bold text-center text-uppercase">Surat Keterangan Belum Pernah Kawin</h6>
									</div>
									<div class="price-value">
										<div class="value">
											<span class="currency"></span>
									...
									<a href="?halaman=request_skbpk" class="btn btn-success btn-round btn-sm mb-3">
						...
						<div class="col-md-3 pr-md-0">
								<div class="card-pricing2 card-primary">
									<div class="pricing-header">
										<h6 class="fw-bold text-center text-uppercase">Surat Keterangan Domisili Orang Asing</h6>
									</div>
									<div class="price-value">
										<div class="value">
											<span class="currency"></span>
									...
									<a href="?halaman=request_skdoa" class="btn btn-primary btn-round btn-sm mb-3"><span class="btn-label">
										<i class="fas fa-plus-circle"></i> Request</a>
								</div>
						</div>
						<div class="col-md-3 pr-md-0">
								<div class="card-pricing2 card-success">
									<div class="pricing-header">
										<h6 class="fw-bold text-center text-uppercase">Surat Keterangan Beda Data</h6>
									</div>
									<div class="price-value">
										<div class="value">
											<span class="currency"></span>
									...
									<a href="?halaman=request_skbd" class="btn btn-success btn-round btn-sm mb-3"><span class="btn-label">
										<i class="fas fa-plus-circle"></i> Request</a>
								</div>
						</div>
						...
						<div class="col-md-3 pr-md-0">
								<div class="card-pricing2 card-warning">
									...
									<a href="?halaman=request_skl" class="btn btn-warning btn-round btn-sm mb-3"><span class="btn-label">
										<i class="fas fa-plus-circle"></i> Request</a>
								</div>
						</div>
						...
						<div class="col-md-3 pr-md-0">
								<div class="card-pricing2 card-secondary">
									...
									<a href="?halaman=request_skkm" class="btn btn-secondary btn-round btn-sm mb-3"><span class="btn-label">
										<i class="fas fa-plus-circle"></i> Request</a>
								</div>
						</div>
	</div>
				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Halo <?php echo $hak_akses;?>!</h2>
								<h5 class="text-white op-7 mb-2">PENGAJUAN SURAT</h5>
							</div>
						</div>
					</div>
				</div>
										...
										<div class="row align-items-center">
											...
											<div class="col col-stats ml-3 ml-sm-0">
												<div class="numbers">
													<p class="card-category">SKBPK</p>
													<?php
													$sql = "SELECT * FROM data_request_skbpk WHERE status=0";
													$query = mysqli_query($konek,$sql);
													$data = mysqli_fetch_array($query,MYSQLI_BOTH);
													$count = mysqli_num_rows($query);
													$status = $data['status'];
									...
									<div class="row align-items-center">
										...
										<div class="col col-stats ml-3 ml-sm-0">
											<div class="numbers">
												<p class="card-category">SKKM</p>
												<?php
													$sql = "SELECT * FROM data_request_skkm WHERE status=0";
													$query = mysqli_query($konek,$sql);
													$data = mysqli_fetch_array($query,MYSQLI_BOTH);
													$count = mysqli_num_rows($query);
													$status = $data['status'];
