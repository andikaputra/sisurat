...
<head>
    ...
    <title>Sistem Informasi Kelurahan Jimbaran</title>
    <!-- core CSS -->
    ...
    <![endif]-->
    <link rel="shortcut icon" href="main/img/logo1.png">
...
<body id="home" class="homepage">
        ...
        <nav id="main-menu" class="navbar navbar-default navbar-fixed-top" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img src="main/img/logo7.png" width="150" height="54" alt="logo"></a>
                </div>
    ...
    <section id="cta2">
        <div class="container">
            <div class="text-center">
                <h2 class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms"><span>PELAYANAN</span> KELURAHAN JIMBARAN</h2>
                    ...
                    <div class="col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                                ...
                                <p>Permohonan di setujui oleh lurah, kemudian pemohon bisa mencetak surat melalui halaman akun masing-masing.</p>
                            </div>
                        </div>
                    </div>
                    <!--/.col-md-4-->
    ...
    <section id="contact">
        <div>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3943.1525220099898!2d115.17056231531687!3d-8.771717392019784!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd244aff3e60dc3%3A0x5f0288ad67fff3d7!2sKantor%20Kelurahan%20Jimbaran!5e0!3m2!1sid!2sid!4v1625161561464!5m2!1sid!2sid" width="100%" height="650px" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0" alt="lokasi kelurahan"></iframe>
        </div>
    </section>
    <!--/#bottom-->
    ...
    <footer id="footer">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy; <?php echo date('Y'); ?> ITB STIKOM JIMBARAN. Credit by <a target="_blank" href="" title="">Asslab Berkarya</a>
                </div>
                <div class="col-sm-6">
