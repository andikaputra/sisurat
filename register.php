...
<body>
          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form method="POST" class="pt-3">
                ...
                <div class="mt-3">
                  <a class="btn btn-block btn-danger btn-lg font-weight-medium auth-form-btn" href="../sisurat">BATAL</a>
                </div>
  ...
  if (isset($_POST['register'])) {
    ...
    if ($query_simpan == 1) {
      ...
      $ins = "INSERT INTO data_pemohon (nik,nama,jekel,tempat_lahir,tanggal_lahir,lingkungan) VALUES ('$nik','$nama','$jekel','$kota','$tgl','$lingkungan')";
