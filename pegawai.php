...
<head>
  ...
  <title>Sistem Informasi Permohonan Surat Kelurahan Jimbaran </title>
...
<body>
  ...
  if (isset($_POST['login'])) {
    ...
    $sql_login = "SELECT * FROM data_pegawai WHERE user='$user' AND password='$password'";
    ...
    if ($jumlah_login > 0) {
      ...
      $_SESSION['user'] = $data_login['user'];
      $_SESSION['lingkungan_tgs'] = $data_login['lingkungan_tgs'];
